...
export default function Home() {
  return (
    <div className="relative w-screen min-h-screen flex flex-col justify-start md:justify-center items-center bg-white dark:bg-gray-900">
      <Head>
      ...
      <Script src="/theme.js" strategy="afterInteractive"></Script>
    </div>
  );
}
